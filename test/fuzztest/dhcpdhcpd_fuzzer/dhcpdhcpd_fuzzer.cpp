...
constexpr size_t MaxIpStringSize = 16;
constexpr size_t MaxInterfaceNameSize = 16;
constexpr int Tow = 2;
...
void TestStartDhcpServerMain(const uint8_t* data, size_t size)
{
    ...
    TestStartDhcpMainInner(data, pos, size, MaxInterfaceNameSize, ifName);
    TestStartDhcpMainInner(data, pos, size, MaxIpStringSize, netMask);
    TestStartDhcpMainInner(data, pos, size, MaxIpStringSize * Tow, ipRange);
    TestStartDhcpMainInner(data, pos, size, MaxIpStringSize, localIp);
}
