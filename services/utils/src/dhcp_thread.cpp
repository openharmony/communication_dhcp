...
public:
    ...
    bool PostSyncTimeOutTask(const std::function<uint32_t>()> callback, uint64_t waitTime)
    {
...
bool DhcpThread::PostSyncTimeOutTask(const std::function<int32_t>()> &callback, uint64_t waitTime)
{
    if (ptr_ == nullptr) {
