...
/* dhcp return code */
enum EnumErrCode {
    DHCP_OPT_SUCCESS = 0,  /* success */
    DHCP_OPT_FAILED,       /* failed */
    DHCP_OPT_NULL,        /* null pointer */
    DHCP_OPT_TIMEOUT,     /* timeout */
    DHCP_OPT_ERROR,       /* error */
    DHCP_OPT_NOT_SUPPORTED, /* not supported */
    DHCP_OPT_NONE,        /* none */
};
